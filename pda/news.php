...
echo '<div class="block_title"><span class="title"><a href="news_show.php?data='.$res[data].'">'.$res[tema].'</a></span><br />'.$ddttn.'</div><div style="float: left; margin-bottom: 10px; border-bottom: 1px #D7D7D7 solid">';

if ($res[oblozka]) echo '<div><img style="box-shadow: 2px 2px 5px rgba(0,0,0,0.3); display: inline;float: left;border: 1px solid #C3D7D4; margin: 0 10px 5px 10px; padding: 10px" src="http://barysh-eparhia.ru/FOTO_MINI/'.$res[oblozka].'.jpg" /></div>';
