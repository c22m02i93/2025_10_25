...
?>
<title><? echo $news_wer[tema];?> - Анонсы</title>
...
{
echo '<li><a href="http://barysh-eparhia.ru/FOTO/'.$albom_mas[$j].'.jpg" rel="lightbox1" class="effectable"><img style="border: 1px solid #BEC7BE; margin: 5px" src="http://barysh-eparhia.ru/FOTO_MINI/'.$albom_mas[$j].'.jpg" /></a></li>';
