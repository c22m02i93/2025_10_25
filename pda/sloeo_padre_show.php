...
if ($news[img]) echo '<span class="photos"><img style="box-shadow: 2px 2px 5px rgba(0,0,0,0.3); display: inline;float: left;border: 1px solid #C3D7D4; margin: 0 10px 5px 10px; padding: 10px" src="http://www.barysh-eparhia.ru/IMG/'.$news[img].'.jpg" /></span>';
